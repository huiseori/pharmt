...
class Medicine(models.Model):
    ...
    item_name = models.CharField(max_length=200, db_index=True, verbose_name="품목명")
    entp_name = models.CharField(max_length=100, null=True, blank=True, verbose_name="업체명")
